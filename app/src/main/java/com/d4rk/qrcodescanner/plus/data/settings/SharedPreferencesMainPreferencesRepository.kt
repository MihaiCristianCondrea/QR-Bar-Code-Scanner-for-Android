...
class SharedPreferencesMainPreferencesRepository(
    ...
    private val bottomNavigationLabelsKey =
    ...
    private val defaultBottomNavigationLabelsValue =
        resources.getString(R.string.default_value_bottom_navigation_bar_labels)
    ...
    private fun readMainPreferences(): MainPreferences {
        ...
        val languageTag =
            preferences.getString(languageKey, defaultLanguageValue) ?: defaultLanguageValue
        val labelsPreference =
            preferences.getString(bottomNavigationLabelsKey, defaultBottomNavigationLabelsValue)
        val startDestinationPreference =
            preferences.getString(defaultTabKey, defaultStartDestinationValue)
