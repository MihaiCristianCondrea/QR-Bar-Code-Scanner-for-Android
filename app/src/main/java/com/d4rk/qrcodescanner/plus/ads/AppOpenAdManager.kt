...
class AppOpenAdManager(
    ...
    private val adUnitId: String = applicationContext.getString(R.string.app_open_ad_unit_id)
    ...
    fun loadAd(context: Context) {
        ...
        val loadContext = context.applicationContext ?: context
