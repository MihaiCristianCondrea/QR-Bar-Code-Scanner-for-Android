...
data class Bookmark(
    ...
    override fun toBarcodeText() : String {
        return StringBuilder().append(SCHEMA_PREFIX).appendIfNotNullOrBlank(TITLE_PREFIX , title , SEPARATOR).appendIfNotNullOrBlank(URL_PREFIX , url , SEPARATOR).append(SEPARATOR).toString()
    }
}