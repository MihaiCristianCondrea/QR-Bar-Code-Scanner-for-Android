...
class ConfirmBarcodeDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState : Bundle?) : Dialog {
        ...
        val dialog = MaterialAlertDialogBuilder(requireActivity()).setTitle(R.string.confirm).setMessage(messageId).setIcon(R.drawable.ic_check).setCancelable(false).setPositiveButton(android.R.string.ok) { _ , _ ->
